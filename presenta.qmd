...
En el modelo de dos parámetros, el valor predichp para cada $Y_i$ depende tanto del intercepto $\beta_0$ como del valor del predictor $X_i$.
...
for (i in 1:1000) {
  ...
  incluye[i] <- between(0.3650, li, ls)
}
